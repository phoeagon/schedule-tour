...
var drawRoute = function(map, events, polylines) {
...
$(document).ready(function () {
    ...
    var events = [];
    //polylines to save all path generated by map api
    var polylines = [];
    //add event listener
